...
- `CONCEPT.md` – Brief notes on the Singleton Pattern and its common implementations.
- `src/Logger.java` – Implementation of the Singleton Logger class.
- `src/SingletonPatternTest.java` – Test class to verify the Singleton behavior.
